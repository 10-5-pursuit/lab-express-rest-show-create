module.exports = [
    ...
    {
      captainName: "Edward Teach",
      title: "Blackbeard",
      post: "Damnation seize my soul if I give you quarters, or take any from you!",
      mistakesWereMadeToday: true,
      daysSinceLastCrisis: 0,
    },
    {
        captainName: "Anne Bonny",
        title: "N/A",
        post: "If you had fought like a man, you need not have been hang'd like a dog.",
        mistakesWereMadeToday: true,
        daysSinceLastCrisis: 0,
      },
      {
        captainName: "John Rackham",
        title: "Calico Jack",
        post: "A merry life and a short one shall be my motto.",
        mistakesWereMadeToday: true,
        daysSinceLastCrisis: 0,
      }
  ];