module.exports = [
    ...
    {
      captainName: "Dick Grayson",
      title: "Nightwing",
      post: "Batman's got it easy, in Bludhaven the cops work against you",
      mistakesWereMadeToday: true,
      daysSinceLastCrisis: 0
    },
    {
      captainName: "Ric Grayson",
      title: "Guy",
      post: "I don't why everyone keeps calling me 'Dick' my name is Ric!",
    ...
    },
    {
      captainName: "Dick Grayson",
      title: "Spy",
      post: "This is becoming dangerous... I miss Babs",
      mistakesWereMadeToday: true,
      daysSinceLastCrisis: 100
    }
  ];